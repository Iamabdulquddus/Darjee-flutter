...
class AllFranchiseList extends StatefulWidget {
  const AllFranchiseList({Key? key}) : super(key: key);
  @override
  State<AllFranchiseList> createState() => _AllFranchiseListState();
}

class _AllFranchiseListState extends State<AllFranchiseList> {
