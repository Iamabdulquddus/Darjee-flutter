...
class AllArticleTitles extends StatefulWidget {
  const AllArticleTitles({Key? key}) : super(key: key);
  @override
  State<AllArticleTitles> createState() => _AllArticleTitlesState();
}

class _AllArticleTitlesState extends State<AllArticleTitles> {
