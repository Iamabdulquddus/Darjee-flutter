...
class AllBrandTitles extends StatefulWidget {
  const AllBrandTitles({Key? key}) : super(key: key);
  @override
  State<AllBrandTitles> createState() => _AllBrandTitlesState();
}

class _AllBrandTitlesState extends State<AllBrandTitles> {
