...
class DeliveredToShop extends StatelessWidget {
  const DeliveredToShop({Key? key}) : super(key: key);
...
class DeliveredToShopList extends StatefulWidget {
  const DeliveredToShopList({Key? key}) : super(key: key);
  @override
  State<DeliveredToShopList> createState() => _DeliveredToShopListState();
}

class _DeliveredToShopListState extends State<DeliveredToShopList> {
