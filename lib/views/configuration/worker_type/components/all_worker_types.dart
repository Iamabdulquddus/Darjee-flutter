...
class AllWorkerTypes extends StatefulWidget {
  const AllWorkerTypes({Key? key}) : super(key: key);
  @override
  State<AllWorkerTypes> createState() => _AllWorkerTypesState();
}

class _AllWorkerTypesState extends State<AllWorkerTypes> {
