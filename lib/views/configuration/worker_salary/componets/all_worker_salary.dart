...
class AllWorkerSalary extends StatefulWidget {
  const AllWorkerSalary({Key? key}) : super(key: key);
  @override
  State<AllWorkerSalary> createState() => _AllWorkerSalaryState();
}

class _AllWorkerSalaryState extends State<AllWorkerSalary> {
